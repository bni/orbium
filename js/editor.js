  ...
  orbium.Editor = function () {
    ...
    this.construct = function () {
      ...
      if (orbium.has_touch_screen) {
        orbium.Util.attachListener(tst, "touchstart", function() {orbium.menu.start();});
      } else {
        orbium.Util.attachListener(tst, "mousedown", function() {orbium.menu.start();});
      }
      ...
      for (var i = 0, j = components.length; i < j; i++) {
        ...
        if (orbium.has_touch_screen) {
          orbium.Util.attachListener(ol, "touchstart", function(e) {orbium.editor.place(e);});
        } else {
          orbium.Util.attachListener(ol, "mousedown", function(e) {orbium.editor.place(e);});
        }
